...
function HeadCount:HeadCountFrameLootManagementPopup_Load(self)
	HeadCountFrame.isLootPopupDisplayed = false
	HeadCountFrame.lootPopupQueue = {}

	_G[self:GetName() .. "LooterLabel"]:SetText(L["Looted by"] .. ": ")
	_G[self:GetName() .. "SourceLabel"]:SetText(L["Loot source"] .. ": ")
	_G[self:GetName() .. "CostLabel"]:SetText(L["Loot cost"] .. ": ")
	_G[self:GetName() .. "NoteLabel"]:SetText(L["Loot note"] .. ": ")
	_G[self:GetName() .. "SaveButton"]:SetText(L["Save"])
	_G[self:GetName() .. "CancelButton"]:SetText(L["Close"])
end
...
function HeadCount:HeadCountFrameLootManagementTemplate_Load(self)
	_G[self:GetName() .. "LooterLabel"]:SetText(L["Looted by"] .. ": ")
	_G[self:GetName() .. "SourceLabel"]:SetText(L["Loot source"] .. ": ")
	_G[self:GetName() .. "CostLabel"]:SetText(L["Loot cost"] .. ": ")
	_G[self:GetName() .. "NoteLabel"]:SetText(L["Loot note"] .. ": ")
	_G[self:GetName() .. "SaveButton"]:SetText(L["Save"])
	_G[self:GetName() .. "CancelButton"]:SetText(L["Cancel"])
end
...
function HeadCount:HeadCountFrameRaidHistoryContentTemplate_Load(self)
	_G[self:GetName() .. "MouseOver"]:SetAlpha(0.3)
	_G[self:GetName() .. "MouseOver"]:SetVertexColor(0.4, 0.4, 1.0)

	_G[self:GetName() .. "MouseSelect"]:SetAlpha(0.6)
	_G[self:GetName() .. "MouseSelect"]:SetVertexColor(0.4, 0.4, 1.0)
end

-- ON LOAD: Raid members template
function HeadCount:HeadCountFrameContentMembersTemplate_Load(self)
	_G[self:GetName() .. "MouseOver"]:SetAlpha(0.3)
	_G[self:GetName() .. "MouseOver"]:SetVertexColor(0.4, 0.4, 1.0)
end

-- ON LOAD: Raid bosses templates
function HeadCount:HeadCountFrameContentBossTemplate_Load(self)
	_G[self:GetName() .. "MouseOver"]:SetAlpha(0.3)
	_G[self:GetName() .. "MouseOver"]:SetVertexColor(0.4, 0.4, 1.0)
end
	...
	if (numberOfRaids > 0) then
		...
		for lineNumber=1,5 do
			...
			if (lineNumberOffset <= numberOfRaids) then
				_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber .. "MouseOver"]:Hide()
				_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber .. "HitArea"]:Show()
				...
				_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber .. "Id"]:SetText(raidId)
				_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber .. "Number"]:SetText(position)
				_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber .. "Time"]:SetText(HeadCount:getDateTimeAsString(raid:retrieveStartingTime()))
				...
				_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber .. "Zone"]:SetText(zone)
				_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber]:Show()
				...
				if (HeadCountFrame.selectedRaidId == raidId) then
					...
					_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber .. "MouseSelect"]:Show()
				else
					-- This line is not equivalent to the currently selected raid id, don't select it
					_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber .. "MouseSelect"]:Hide()
				end
			else
				_G["HeadCountFrameRaidHistoryContentEntry" .. lineNumber]:Hide()
			end
		end

		_G["HeadCountFrameRaidHistoryContent"]:Show()
	else
		-- No raids exist
		_G["HeadCountFrameRaidHistoryContent"]:Hide()	-- hide the raid history content frame
	end
		...
		if (numberOfPlayers > 0) then
			...
			for lineNumber=1,10 do
				...
				if (lineNumberOffset <= numberOfPlayers) then
					_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "MouseOver"]:Hide()
					_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "HitArea"]:Show()
					local player = orderedPlayerList[lineNumberOffset]

					_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "Number"]:SetText(lineNumberOffset)
					_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "Name"]:SetText(player:getName())
					_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "BeginTime"]:SetText(HeadCount:getTimeAsString(player:retrieveStartingTime()))

					if (player:retrieveEndingTime()) then
						-- end time exists
						_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "EndTime"]:SetText(HeadCount:getTimeAsString(player:retrieveEndingTime()))
					else
						-- end time not yet set, show nothing
						_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "EndTime"]:SetText("")
					end

					if (raid:getIsFinalized()) then
						-- raid is finalized, show total time
						_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "TotalTime"]:SetText(HeadCount:getSecondsAsString(player:getTotalTime()))
					else
						-- raid is not finalized show nothing
						_G["HeadCountFrameContentMembersEntry" .. lineNumber .. "TotalTime"]:SetText("")
					end

					_G["HeadCountFrameContentMembersEntry" .. lineNumber]:Show()
				else
					_G["HeadCountFrameContentMembersEntry" .. lineNumber]:Hide()
				end
			end
		...
		if (numberOfPlayers > 0) then
			...
			for lineNumber=1,10 do
				...
				if (lineNumberOffset <= numberOfPlayers) then
					...
					_G["HeadCountFrameContentWaitListEntry" .. lineNumber .. "Number"]:SetText(lineNumberOffset)
					_G["HeadCountFrameContentWaitListEntry" .. lineNumber .. "Name"]:SetText(player:getName())
					_G["HeadCountFrameContentWaitListEntry" .. lineNumber .. "Time"]:SetText(HeadCount:getTimeAsString(player:getWaitlistActivityTime()))
					_G["HeadCountFrameContentWaitListEntry" .. lineNumber .. "Note"]:SetText(player:getWaitlistNote())
					_G["HeadCountFrameContentWaitListEntry" .. lineNumber]:Show()
				else
					_G["HeadCountFrameContentWaitListEntry" .. lineNumber]:Hide()
				end
			end
		...
		if (numberOfBosses > 0) then
			...
			for lineNumber=1,10 do
				...
				if (lineNumberOffset <= numberOfBosses) then
					_G["HeadCountFrameContentBossEntry" .. lineNumber .. "MouseOver"]:Hide()
					_G["HeadCountFrameContentBossEntry" .. lineNumber .. "HitArea"]:Show()
					local boss = orderedBossList[lineNumberOffset]

					_G["HeadCountFrameContentBossEntry" .. lineNumber .. "Number"]:SetText(lineNumberOffset)
					_G["HeadCountFrameContentBossEntry" .. lineNumber .. "Time"]:SetText(HeadCount:getTimeAsString(boss:getActivityTime()))
					_G["HeadCountFrameContentBossEntry" .. lineNumber .. "Members"]:SetText(boss:numberOfPlayers())
					_G["HeadCountFrameContentBossEntry" .. lineNumber .. "Name"]:SetText(boss:getName())

					_G["HeadCountFrameContentBossEntry" .. lineNumber]:Show()
				else
					_G["HeadCountFrameContentBossEntry" .. lineNumber]:Hide()
				end
			end
		...
		if (numberOfLoots > 0) then
			...
			for lineNumber=1,5 do
				...
				if (lineNumberOffset <= numberOfLoots) then
					...
					_G["HeadCountFrameContentLootEntry" .. lineNumber .. "Id"]:SetText(loot:getItemId())

					local texture = loot:getTexture()
					if (texture) then
						_G["HeadCountFrameContentLootEntry" .. lineNumber .. "TextureButton"]:SetNormalTexture(texture)
					else
						_G["HeadCountFrameContentLootEntry" .. lineNumber .. "TextureButton"]:SetNormalTexture("Interface\Icons\INV_Misc_QuestionMark")
					end

					_G["HeadCountFrameContentLootEntry" .. lineNumber .. "Number"]:SetText(lineNumberOffset)

					local link = loot:getLink()
					if (link) then
						_G["HeadCountFrameContentLootEntry" .. lineNumber .. "NameButtonText"]:SetText(link)
					else
						_G["HeadCountFrameContentLootEntry" .. lineNumber .. "NameButtonText"]:SetText(L["Item unavailable"])
					end

					_G["HeadCountFrameContentLootEntry" .. lineNumber .. "Looter"]:SetText(L["Looted by"] .. " " .. loot:getPlayerName() .. " (" .. HeadCount:getDateTimeAsString(loot:getActivityTime())  .. ")")

					_G["HeadCountFrameContentLootEntry" .. lineNumber]:Show()
				else
					_G["HeadCountFrameContentLootEntry" .. lineNumber]:Hide()
				end
			end
		...
		if ((player) and (lootList)) then
			...
			for lineNumber=1,10 do
				...
				if (lineNumberOffset <= numberOfPlayerInformationListLines) then
					_G["HeadCountFrameContentPlayerEntry" .. lineNumber .. "SimpleHTML"]:SetText(playerInformationList[lineNumberOffset])
					_G["HeadCountFrameContentPlayerEntry" .. lineNumber]:Show()
				else
					_G["HeadCountFrameContentPlayerEntry" .. lineNumber]:Hide()
				end
			end
		...
		if (boss) then
			...
			if (numberOfPlayers > 0) then
				...
				for lineNumber=1,10 do
					...
					if (lineNumberOffset <= numberOfPlayers) then
						_G["HeadCountFrameContentSnapshotEntry" .. lineNumber .. "Number"]:SetText(lineNumberOffset)
						_G["HeadCountFrameContentSnapshotEntry" .. lineNumber .. "Name"]:SetText(snapshotList[lineNumberOffset])
						_G["HeadCountFrameContentSnapshotEntry" .. lineNumber]:Show()
					else
						_G["HeadCountFrameContentSnapshotEntry" .. lineNumber]:Hide()
					end
				end
...
function HeadCount:HeadCountFrameContentMembers_Show(isShowing)
	if (isShowing) then
		_G["HeadCountFrameContentMembersNameButton"]:Show()
		_G["HeadCountFrameContentMembersStartTimeButton"]:Show()
		_G["HeadCountFrameContentMembersEndTimeButton"]:Show()
		_G["HeadCountFrameContentMembersTotalTimeButton"]:Show()

		_G["HeadCountFrameContentMembers"]:Show()
	else
		for lineNumber=1,10 do
			_G["HeadCountFrameContentMembersEntry" .. lineNumber]:Hide()
		end

		_G["HeadCountFrameContentMembersNameButton"]:Hide()
		_G["HeadCountFrameContentMembersStartTimeButton"]:Hide()
		_G["HeadCountFrameContentMembersEndTimeButton"]:Hide()
		_G["HeadCountFrameContentMembersTotalTimeButton"]:Hide()

		_G["HeadCountFrameContentMembers"]:Hide()
	end
end
...
function HeadCount:HeadCountFrameContentWaitList_Show(isShowing)
	if (isShowing) then
		_G["HeadCountFrameContentWaitListNameButton"]:Show()
		_G["HeadCountFrameContentWaitListTimeButton"]:Show()
		_G["HeadCountFrameContentWaitListNoteButton"]:Show()

		_G["HeadCountFrameContentWaitList"]:Show()
	else
		for lineNumber=1,10 do
			_G["HeadCountFrameContentWaitListEntry" .. lineNumber]:Hide()
		end

		_G["HeadCountFrameContentWaitListNameButton"]:Hide()
		_G["HeadCountFrameContentWaitListTimeButton"]:Hide()
		_G["HeadCountFrameContentWaitListNoteButton"]:Hide()

		_G["HeadCountFrameContentWaitList"]:Hide()
	end
end
...
function HeadCount:HeadCountFrameContentBoss_Show(isShowing)
	if (isShowing) then
		_G["HeadCountFrameContentBossTimeButton"]:Show()
		_G["HeadCountFrameContentBossMembersButton"]:Show()
		_G["HeadCountFrameContentBossNameButton"]:Show()

		_G["HeadCountFrameContentBoss"]:Show()
	else
		_G["HeadCountFrameContentBossTimeButton"]:Hide()
		_G["HeadCountFrameContentBossMembersButton"]:Hide()
		_G["HeadCountFrameContentBossNameButton"]:Hide()

		_G["HeadCountFrameContentBoss"]:Hide()
	end
end
...
function HeadCount:HeadCountFrameContentLoot_Show(isShowing)
	if (isShowing) then
		_G["HeadCountFrameContentLoot"]:Show()
	else
		_G["HeadCountFrameContentLoot"]:Hide()
	end
end
...
function HeadCount:HeadCountFrameContentPlayer_Show(isShowing)
	if (isShowing) then
		_G["HeadCountFrameContentPlayerNameString"]:Show()
		_G["HeadCountFrameContentPlayerBackButton"]:Show()

		_G["HeadCountFrameContentPlayer"]:Show()
	else
		_G["HeadCountFrameContentPlayerNameString"]:Hide()
		_G["HeadCountFrameContentPlayerBackButton"]:Hide()

		_G["HeadCountFrameContentPlayer"]:Hide()
	end
end
...
function HeadCount:HeadCountFrameContentSnapshot_Show(isShowing)
	if (isShowing) then
		_G["HeadCountFrameContentSnapshotNameString"]:Show()
		_G["HeadCountFrameContentSnapshotBackButton"]:Show()

		_G["HeadCountFrameContentSnapshot"]:Show()
	else
		_G["HeadCountFrameContentSnapshotNameString"]:Hide()
		_G["HeadCountFrameContentSnapshotBackButton"]:Hide()

		_G["HeadCountFrameContentSnapshot"]:Hide()
	end
end
...
function HeadCount:HeadCountFrameRaidHistoryContentTemplateHitArea_Click(self)
	local raidId = tonumber(_G[self:GetParent():GetName() .. "Id"]:GetText())	-- save the selected raid id
...
function HeadCount:HeadCountFrameRaidHistoryContentTemplateExportButton_Click(self)
	local raidTracker = HeadCount:getRaidTracker()
	local currentRaidId = raidTracker:retrieveCurrentRaidId()
	local isCurrentRaidActive = raidTracker:getIsCurrentRaidActive()

	local raidId = tonumber(_G[self:GetParent():GetName() .. "Id"]:GetText())
...
function HeadCount:HeadCountFrameRaidHistoryContentTemplateDeleteButton_Click(self)
	local raidId = tonumber(_G[self:GetParent():GetName() .. "Id"]:GetText())
...
function HeadCount:HeadCountFrameContentMembersTemplateHitArea_Click(self)
	HeadCount:DisableModalFrame()

	HeadCountFrame.playerName = _G[self:GetParent():GetName() .. "Name"]:GetText()
	HeadCountFrame.contentType = content["player"]
	HeadCount:HeadCountFrame_Update()
end

-- ON CLICK: Member delete button
function HeadCount:HeadCountFrameContentMembersTemplateDeleteButton_Click(self)
	HeadCountFrameConfirm.playerId = tonumber(_G[self:GetParent():GetName() .. "Number"]:GetText())
	HeadCountFrameConfirm.description = _G[self:GetParent():GetName() .. "Name"]:GetText()
...
function HeadCount:HeadCountFrameContentWaitListTemplateRemoveButton_Click(self)
	HeadCountFrameConfirm.waitListId = tonumber(_G[self:GetParent():GetName() .. "Number"]:GetText())
	HeadCountFrameConfirm.description = _G[self:GetParent():GetName() .. "Name"]:GetText()
...
function HeadCount:HeadCountFrameContentBossTemplateHitArea_Click(self)
	HeadCount:DisableModalFrame()

	HeadCountFrame.bossName = _G[self:GetParent():GetName() .. "Name"]:GetText()
	HeadCountFrame.contentType = content["snapshot"]
	HeadCount:HeadCountFrame_Update()
end

-- ON CLICK: Boss delete button
function HeadCount:HeadCountFrameContentBossTemplateDeleteButton_Click(self)
	HeadCountFrameConfirm.bossId = tonumber(_G[self:GetParent():GetName() .. "Number"]:GetText())
	HeadCountFrameConfirm.description = _G[self:GetParent():GetName() .. "Name"]:GetText()
...
function HeadCount:HeadCountFrameContentSnapshotTemplateRemoveButton_Click(self)
	HeadCountFrameConfirm.attendeeId = tonumber(_G[self:GetParent():GetName() .. "Number"]:GetText())
	HeadCountFrameConfirm.description = _G[self:GetParent():GetName() .. "Name"]:GetText()
...
function HeadCount:HeadCountFrameContentLootTemplateTextureButton_Click(self)
	local itemId = _G[self:GetParent():GetName() .. "Id"]:GetText()
...
function HeadCount:HeadCountFrameContentLootTemplateNameButton_Click(self)
	local itemId = _G[self:GetParent():GetName() .. "Id"]:GetText()
...
function HeadCount:HeadCountFrameContentLootTemplateManagementButton_Click(self)
	local lootId = tonumber(_G[self:GetParent():GetName() .. "Number"]:GetText())
	local raidId = HeadCountFrame.selectedRaidId
...
function HeadCount:HeadCountFrameContentLootTemplateDeleteButton_Click(self)
	HeadCountFrameConfirm.lootId = tonumber(_G[self:GetParent():GetName() .. "Number"]:GetText())
	HeadCountFrameConfirm.description = _G[self:GetParent():GetName() .. "NameButtonText"]:GetText()
...
function HeadCount:HeadCountFrameExportRefreshButton_Click(self)
	local raidId = tonumber(_G[self:GetParent():GetName() .. "Id"]:GetText())
...
function HeadCount:HeadCountFrameRaidHistoryAnnounceButton_Enter(self)
	GameTooltip:SetOwner(_G[self:GetName()], "ANCHOR_RIGHT", -6, 0)
...
function HeadCount:HeadCountFrameRaidHistoryEndRaidButton_Enter(self)
	GameTooltip:SetOwner(_G[self:GetName()], "ANCHOR_RIGHT", -6, 0)
	GameTooltip:ClearLines()
...
function HeadCount:HeadCountFrameRaidHistoryRemoveAllButton_Enter(self)
	GameTooltip:SetOwner(_G[self:GetName()], "ANCHOR_RIGHT", -6, 0)
	GameTooltip:ClearLines()
...
function HeadCount:HeadCountFrameRaidHistoryContentTemplateExportButton_Enter(self)
	local raidId = tonumber(_G[self:GetParent():GetName() .. "Id"]:GetText())
	local orderedRaidId = _G[self:GetParent():GetName() .. "Number"]:GetText()
	local raidTime = _G[self:GetParent():GetName() .. "Time"]:GetText()
	local zone = _G[self:GetParent():GetName() .. "Zone"]:GetText()
...
function HeadCount:HeadCountFrameRaidHistoryContentTemplateHitArea_Enter(self)
	_G[self:GetParent():GetName() .. "MouseOver"]:Show()
end

-- ON ENTER: Raid delete button
function HeadCount:HeadCountFrameRaidHistoryContentTemplateDeleteButton_Enter(self)
	local raidId = tonumber(_G[self:GetParent():GetName() .. "Id"]:GetText())
	local raidNumber = _G[self:GetParent():GetName() .. "Number"]:GetText()
	local raidTime = _G[self:GetParent():GetName() .. "Time"]:GetText()
	local zone = _G[self:GetParent():GetName() .. "Zone"]:GetText()
...
function HeadCount:HeadCountFrameContentMembersButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
...
function HeadCount:HeadCountFrameContentWaitListButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)
	local raidZone = selectedRaid:getZone()
	local difficulty = selectedRaid:getDifficulty()
...
function HeadCount:HeadCountFrameContentBossButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)
	local raidZone = selectedRaid:getZone()
	local difficulty = selectedRaid:getDifficulty()
...
function HeadCount:HeadCountFrameContentLootButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)
	local raidZone = selectedRaid:getZone()
	local difficulty = selectedRaid:getDifficulty()
...
function HeadCount:HeadCountFrameContentMembersTemplateHitArea_Enter(self)
	_G[self:GetParent():GetName() .. "MouseOver"]:Show()
end

-- ON ENTER: Raid member delete button
function HeadCount:HeadCountFrameContentMembersTemplateDeleteButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)
	local raidZone = selectedRaid:getZone()
	local difficulty = selectedRaid:getDifficulty()
...
function HeadCount:HeadCountFrameContentSnapshotTemplateRemoveButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)
	local raidZone = selectedRaid:getZone()
	local difficulty = selectedRaid:getDifficulty()
...
function HeadCount:HeadCountFrameContentWaitListTemplateRemoveButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)
	local raidZone = selectedRaid:getZone()

	local waitListId = _G[self:GetParent():GetName() .. "Number"]:GetText()
	local name = _G[self:GetParent():GetName() .. "Name"]:GetText()
...
function HeadCount:HeadCountFrameContentBossTemplateHitArea_Enter(self)
	_G[self:GetParent():GetName() .. "MouseOver"]:Show()
end

-- ON ENTER: Raid boss delete button
function HeadCount:HeadCountFrameContentBossTemplateDeleteButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)
	local raidZone = selectedRaid:getZone()
	local difficulty = selectedRaid:getDifficulty()
...
function HeadCount:HeadCountFrameContentLootTemplateTextureButton_Enter(self)
	local link = _G[self:GetParent():GetName() .. "NameButtonText"]:GetText()
	local itemId = _G[self:GetParent():GetName() .. "Id"]:GetText()
...
function HeadCount:HeadCountFrameContentLootTemplateManagementButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)

	local lootName = _G[self:GetParent():GetName() .. "NameButtonText"]:GetText()
	local lootId = tonumber(_G[self:GetParent():GetName() .. "Number"]:GetText())
...
function HeadCount:HeadCountFrameContentLootTemplateDeleteButton_Enter(self)
	local raidTracker = HeadCount:getRaidTracker()
	local selectedRaid = raidTracker:getRaidById(HeadCountFrame.selectedRaidId)
...
function HeadCount:HeadCountFrameLootManagementBankButton_Enter(self)
	GameTooltip:SetOwner(self, "ANCHOR_RIGHT", -6, 0)
	GameTooltip:ClearLines()
...
function HeadCount:HeadCountFrameLootManagementDisenchantedButton_Enter(self)
	GameTooltip:SetOwner(self, "ANCHOR_RIGHT", -6, 0)
	GameTooltip:ClearLines()
...
function HeadCount:HeadCountFrameLootManagementOffspecButton_Enter(self)
	GameTooltip:SetOwner(self, "ANCHOR_RIGHT", -6, 0)
	GameTooltip:ClearLines()
...
function HeadCount:HideMouseOver(self)
	_G[self:GetParent():GetName() .. "MouseOver"]:Hide()
end
